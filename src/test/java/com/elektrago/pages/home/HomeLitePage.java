...
public class HomeLitePage {
    ...
    @iOSXCUITFindBy(accessibility = "**/XCUIElementTypeWindow[1]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[1]/XCUIElementTypeScrollView/XCUIElementTypeOther[1]/XCUIElementTypeOther/XCUIElementTypeOther[1]/XCUIElementTypeOther/XCUIElementTypeImage")
    public WebElement btnMenu;

    @iOSXCUITFindBy(accessibility = "**/XCUIElementTypeButton[`name == \"Log out\"`]")
    public WebElement btnLogout;

    @iOSXCUITFindBy(accessibility = "**/XCUIElementTypeButton[`name == \"Log out\"`][2]")
    public WebElement btnConfirmLogout;
